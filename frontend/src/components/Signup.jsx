    ...
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-3xl shadow-2xl p-8">
          <h2 className="text-xl font-bold text-neutral-100 mb-1">Create your account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-sm font-medium text-neutral-300 block mb-1.5">Full Name</label>
            ...
            <div>
              <label className="text-sm font-medium text-neutral-300 block mb-1.5">Currency</label>
              <div className="relative">
                <IndianRupee size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-neutral-500" />
          ...
          <p className="text-center text-sm text-neutral-500 mt-6">
            ...
            <Link to="/login" className="text-orange-500 font-semibold hover:text-orange-400">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
